...
public class HomeController {
    ...
    public String afficherAccueil(
        ...
        List<Annonce> annonces = annonceRepository.findAll().stream()
                ...
                .filter(a -> (categorie == null || a.getCategorie().getName().toLowerCase().contains(categorie.toLowerCase())))

                .filter(a -> (typeAnnonce == null || (a.getBien() != null && a.getBien().getType().toLowerCase().contains(typeAnnonce.toLowerCase()))))
