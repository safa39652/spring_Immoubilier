...
public class HomeController {
    ...
    public String afficherAccueil(
        ...
        System.out.println("Type de bien: " + typeBien);
        ...
        List<Annonce> annonces = annonceRepository.findAll().stream()
                ...
                .filter(a -> (categorie == null || a.getCategorie().toLowerCase().contains(categorie.toLowerCase())))
                .filter(a -> (typeBien == null || a.getTypeBien().toLowerCase().contains(typeBien.toLowerCase())))
